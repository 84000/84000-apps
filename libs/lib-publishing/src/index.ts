 ...
 * (`validate_work_for_publish`), so there is exactly one implementation and DEV-718's
 * editor view cannot disagree with the publish gate. This entry point carries the finding
