...
- **Frontend** - Frontend app in Next.js.
- **Functions** - Contains all the supabase edge functions for backend tasks and cron jobs. Also included and e2e testing environment.
